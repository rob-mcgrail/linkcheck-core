...
A linkchecker with web interface, developed to assist in the Channel Support maintanence of TKI.

The linkchecker had a user interface was at: "http://linkcheck-live":http://linkcheck-live

Some external tools made use of this web-interface for ingesting data. For example, CMIS. For more information see the CMIS documentation.
